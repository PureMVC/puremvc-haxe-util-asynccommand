...
org.puremvc.haxe.multicore.interfaces.IAsyncCommand = function() { }
org.puremvc.haxe.multicore.interfaces.IAsyncCommand.__name__ = ["org","puremvc","haxe","multicore","interfaces","IAsyncCommand"];
org.puremvc.haxe.multicore.interfaces.IAsyncCommand.prototype.setOnComplete = null;
org.puremvc.haxe.multicore.interfaces.IAsyncCommand.prototype.__class__ = org.puremvc.haxe.multicore.interfaces.IAsyncCommand;
org.puremvc.haxe.multicore.interfaces.IAsyncCommand.__interfaces__ = [org.puremvc.haxe.multicore.interfaces.ICommand];
org.puremvc.haxe.multicore.patterns.command.AsyncCommand = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.command.SimpleCommand.apply(this,[]);
}}
org.puremvc.haxe.multicore.patterns.command.AsyncCommand.__name__ = ["org","puremvc","haxe","multicore","patterns","command","AsyncCommand"];
org.puremvc.haxe.multicore.patterns.command.AsyncCommand.__super__ = org.puremvc.haxe.multicore.patterns.command.SimpleCommand;
for(var k in org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype ) org.puremvc.haxe.multicore.patterns.command.AsyncCommand.prototype[k] = org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype[k];
org.puremvc.haxe.multicore.patterns.command.AsyncCommand.prototype.commandComplete = function() {
	this.onComplete();
}
org.puremvc.haxe.multicore.patterns.command.AsyncCommand.prototype.onComplete = null;
org.puremvc.haxe.multicore.patterns.command.AsyncCommand.prototype.setOnComplete = function(value) {
	this.onComplete = value;
}
org.puremvc.haxe.multicore.patterns.command.AsyncCommand.prototype.__class__ = org.puremvc.haxe.multicore.patterns.command.AsyncCommand;
org.puremvc.haxe.multicore.patterns.command.AsyncCommand.__interfaces__ = [org.puremvc.haxe.multicore.interfaces.IAsyncCommand];
...
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.observer.Notifier.apply(this,[]);
	this.subCommands = new List();
	this.initializeAsyncMacroCommand();
}}
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.__name__ = ["org","puremvc","haxe","multicore","patterns","command","AsyncMacroCommand"];
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.__super__ = org.puremvc.haxe.multicore.patterns.observer.Notifier;
for(var k in org.puremvc.haxe.multicore.patterns.observer.Notifier.prototype ) org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.prototype[k] = org.puremvc.haxe.multicore.patterns.observer.Notifier.prototype[k];
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.prototype.addSubCommand = function(commandClassRef) {
	this.subCommands.add(commandClassRef);
}
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.prototype.execute = function(notification) {
	this.note = notification;
	this.nextCommand();
}
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.prototype.initializeAsyncMacroCommand = function() {
	null;
}
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.prototype.nextCommand = function() {
	if(!this.subCommands.isEmpty()) {
		var commandClassRef = this.subCommands.pop();
		var commandInstance = Type.createInstance(commandClassRef,[]);
		var isAsync = Std["is"](commandInstance,org.puremvc.haxe.multicore.interfaces.IAsyncCommand);
		if(isAsync) function($this) {
			var $r;
			var tmp = commandInstance;
			$r = (Std["is"](tmp,org.puremvc.haxe.multicore.interfaces.IAsyncCommand)?tmp:function($this) {
				var $r;
				throw "Class cast error";
				return $r;
			}($this));
			return $r;
		}(this).setOnComplete($closure(this,"nextCommand"));
...
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.prototype.note = null;
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.prototype.onComplete = null;
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.prototype.setOnComplete = function(value) {
	this.onComplete = value;
}
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.prototype.subCommands = null;
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.prototype.__class__ = org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand;
org.puremvc.haxe.multicore.patterns.command.AsyncMacroCommand.__interfaces__ = [org.puremvc.haxe.multicore.interfaces.INotifier,org.puremvc.haxe.multicore.interfaces.IAsyncCommand];
