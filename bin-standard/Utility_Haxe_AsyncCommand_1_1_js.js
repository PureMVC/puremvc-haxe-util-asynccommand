...
org.puremvc.haxe.patterns.command.AsyncMacroCommand.prototype.nextCommand = function() {
	if(!this.subCommands.isEmpty()) {
		...
		if(isAsync) function($this) {
			...
			$r = (Std["is"](tmp,org.puremvc.haxe.interfaces.IAsyncCommand)?tmp:function($this) {
				var $r;
...
org.puremvc.haxe.patterns.command.AsyncCommand = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.patterns.command.SimpleCommand.apply(this,[]);
}}
org.puremvc.haxe.patterns.command.AsyncCommand.__name__ = ["org","puremvc","haxe","patterns","command","AsyncCommand"];
org.puremvc.haxe.patterns.command.AsyncCommand.__super__ = org.puremvc.haxe.patterns.command.SimpleCommand;
for(var k in org.puremvc.haxe.patterns.command.SimpleCommand.prototype ) org.puremvc.haxe.patterns.command.AsyncCommand.prototype[k] = org.puremvc.haxe.patterns.command.SimpleCommand.prototype[k];
org.puremvc.haxe.patterns.command.AsyncCommand.prototype.commandComplete = function() {
	this.onComplete();
}
org.puremvc.haxe.patterns.command.AsyncCommand.prototype.onComplete = null;
org.puremvc.haxe.patterns.command.AsyncCommand.prototype.setOnComplete = function(value) {
	this.onComplete = value;
}
org.puremvc.haxe.patterns.command.AsyncCommand.prototype.__class__ = org.puremvc.haxe.patterns.command.AsyncCommand;
org.puremvc.haxe.patterns.command.AsyncCommand.__interfaces__ = [org.puremvc.haxe.interfaces.IAsyncCommand];
